...
from ..eventloop import aclosing, generator_to_async_generator
from ..filters import FilterOrBool, to_filter
from ..formatted_text import AnyFormattedText, StyleAndTextTuples
...
class Completion:
    ...
    def display_text(self) -> str:
        ...
        from ..formatted_text import fragment_list_to_text
...
class Completer(metaclass=ABCMeta):
    ...
    def get_completions(
        ...
        :param document: :class:`~..document.Document` instance.
