...
from ..filters import FilterOrBool, to_filter, vi_insert_multiple_mode
from ..formatted_text import (
    AnyFormattedText,
    StyleAndTextTuples,
    to_formatted_text,
)
from ..formatted_text.utils import fragment_list_len, fragment_list_to_text
...
class Processor(metaclass=ABCMeta):
    ...
    :class:`~..layout.controls.BufferControl`.
    """
...
class ConditionalProcessor(Processor):
    ...
    :param filter: :class:`~..filters.Filter` instance.
    """
