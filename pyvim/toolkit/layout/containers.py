...
from ..formatted_text.utils import (
    fragment_list_to_text,
    fragment_list_width,
)
from ..key_binding import KeyBindingsBase
from ..mouse_events import MouseEvent, MouseEventType
from ..utils import get_cwidth, take_using_weights, to_int, to_str
...
if TYPE_CHECKING:
    ...
    from ..key_binding.key_bindings import NotImplementedOrNone
...
class Container(metaclass=ABCMeta):
    ...
    def preferred_width(self, max_available_width: int) -> Dimension:
        """
        Return a :class:`~..layout.Dimension` that represents the
    ...
    def write_to_screen(
        ...
        :param screen: :class:`~..layout.screen.Screen`
        :param mouse_handlers: :class:`~..layout.mouse_handlers.MouseHandlers`.
...
class HSplit(_Split):
    ...
    def write_to_screen(
        ...
        :param screen: The :class:`~..layout.screen.Screen` class
...
class WindowRenderInfo:
    ...
    :class:`~..layout.controls.BufferControl`) and the actual
...
class Window(Container):
    ...
    :param left_margins: A list of :class:`.Margin` instance to be displayed on
        the left. For instance: :class:`~..layout.NumberedMargin`
