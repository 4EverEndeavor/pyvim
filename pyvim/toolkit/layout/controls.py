...
from ..mouse_events import MouseButton, MouseEvent, MouseEventType
...
class FormattedTextControl(UIControl):
    ...
    :class:`~..formatted_text.HTML` object an
    :class:`~..formatted_text.ANSI` object, a list of ``(style_str,
    ...
    ``..layout.formatted_text`` for more information.
    ...
    :param style: Style string applied to the content. (If you want to style
        the whole :class:`~..layout.Window`, pass the style to the
        :class:`~..layout.Window` instead.)
    ...
    def mouse_handler(self, mouse_event: MouseEvent) -> NotImplementedOrNone:
        ...
        :class:`~..layout.Window` to handle this particular
        event.)
        """
        if self._fragments:
            # Read the generator.
...
class DummyControl(UIControl):
    ...
    Useful for filling a :class:`~..layout.Window`. (The
...
class BufferControl(UIControl):
    ...
    :param input_processors: A list of
        :class:`~..layout.processors.Processor` objects.
