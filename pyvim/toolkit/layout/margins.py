"""
Margin implementations for a :class:`~..layout.containers.Window`.
"""
...
class Margin(metaclass=ABCMeta):
    ...
    def create_margin(
        ...
        :param window_render_info:
            :class:`~..layout.containers.WindowRenderInfo`
            instance, generated after rendering and copying the visible part of
            the :class:`~..layout.controls.UIControl` into the
            :class:`~..layout.containers.Window`.
        :param width: The width that's available for this margin. (As reported
            by :meth:`.get_width`.)
        :param height: The height that's available for this margin. (The height
            of the :class:`~..layout.containers.Window`.)
        """
        return []
