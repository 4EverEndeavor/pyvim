...
from ..auto_suggest import AutoSuggest, DynamicAutoSuggest
from ..buffer import Buffer
from ..clipboard import Clipboard, DynamicClipboard, InMemoryClipboard
from ..completion import Completer, DynamicCompleter, ThreadedCompleter
from ..cursor_shapes import (
...
from ..key_binding.bindings.auto_suggest import load_auto_suggest_bindings
from ..key_binding.bindings.completion import (
    display_completions_like_readline,
)
from ..key_binding.bindings.open_in_editor import (
    load_open_in_editor_bindings,
)
from ..key_binding.key_bindings import (
...
from ..key_binding.key_processor import KeyPressEvent
from ..keys import Keys
from ..layout import Float, FloatContainer, HSplit, Window
from ..layout.containers import ConditionalContainer, WindowAlign
...
from ..layout.utils import explode_text_fragments
from ..lexers import DynamicLexer, Lexer
from ..output import ColorDepth, DummyOutput, Output
from ..styles import (
    BaseStyle,
...
from ..validation import DynamicValidator, Validator
...
if TYPE_CHECKING:
    from ..formatted_text.base import MagicFormattedText
...
class PromptSession(Generic[_T]):
    ...
    This is a wrapper around a lot of ``toolkit`` functionality and can
    ...
    :param multiline: `bool` or :class:`~toolkit.filters.Filter`.
        When True, prefer a layout that is more adapted for multiline input.
        Text after newlines is automatically indented, and search/arg input is
        shown below the input, instead of replacing the prompt.
    :param wrap_lines: `bool` or :class:`~toolkit.filters.Filter`.
    ...
    :param complete_while_typing: `bool` or
        :class:`~toolkit.filters.Filter`. Enable autocompletion while
        typing.
    :param validate_while_typing: `bool` or
        :class:`~toolkit.filters.Filter`. Enable input validation while
        typing.
    :param enable_history_search: `bool` or
        :class:`~toolkit.filters.Filter`. Enable up-arrow parting
        string matching.
    :param search_ignore_case:
        :class:`~toolkit.filters.Filter`. Search case insensitive.
    :param lexer: :class:`~toolkit.lexers.Lexer` to be used for the
        syntax highlighting.
    :param validator: :class:`~toolkit.validation.Validator` instance
        for input validation.
    :param completer: :class:`~toolkit.completion.Completer` instance
        for input completion.
    :param complete_in_thread: `bool` or
        :class:`~toolkit.filters.Filter`. Run the completer code in a
    ...
    :param auto_suggest: :class:`~toolkit.auto_suggest.AutoSuggest`
        instance for input suggestions.
    :param style: :class:`.Style` instance for the color scheme.
    :param include_default_pygments_style: `bool` or
        :class:`~toolkit.filters.Filter`. Tell whether the default
    ...
    :param style_transformation:
        :class:`~toolkit.style.StyleTransformation` instance.
    :param swap_light_and_dark_colors: `bool` or
        :class:`~toolkit.filters.Filter`. When enabled, apply
        :class:`~toolkit.style.SwapLightAndDarkStyleTransformation`.
        This is useful for switching between dark and light terminal
        backgrounds.
    :param enable_system_prompt: `bool` or
        :class:`~toolkit.filters.Filter`. Pressing Meta+'!' will show
        a system prompt.
    :param enable_suspend: `bool` or :class:`~toolkit.filters.Filter`.
        Enable Control-Z style suspension.
    :param enable_open_in_editor: `bool` or
        :class:`~toolkit.filters.Filter`. Pressing 'v' in Vi mode or
        C-X C-E in emacs mode will open an external editor.
    :param history: :class:`~toolkit.history.History` instance.
    :param clipboard: :class:`~toolkit.clipboard.Clipboard` instance.
        (e.g. :class:`~toolkit.clipboard.InMemoryClipboard`)
    ...
    :param mouse_support: `bool` or :class:`~toolkit.filters.Filter`
