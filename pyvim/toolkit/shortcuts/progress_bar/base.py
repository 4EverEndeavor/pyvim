"""
Progress bar implementation on top of ...
...
from ...application.current import get_app_session
from ...filters import Condition, is_done, renderer_height_is_known
...
from ...layout.controls import UIContent, UIControl
from ...layout.dimension import AnyDimension, D
from ...output import ColorDepth, Output
from ...styles import BaseStyle
from ...utils import in_main_thread
...
class ProgressBar:
    ...
    :param style: :class:`...styles.BaseStyle` instance.
    ...
    :param color_depth: `toolkit` `ColorDepth` instance.
    :param output: :class:`~toolkit.output.Output` instance.
