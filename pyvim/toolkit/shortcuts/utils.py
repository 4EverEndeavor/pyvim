...
from ..application.current import get_app_or_none, get_app_session
...
if TYPE_CHECKING:
    from ..layout.containers import AnyContainer
...
def print_formatted_text(
    *values: Any,
    ...
    :class:`~toolkit.formatted_text.FormattedText`,
    :class:`~toolkit.formatted_text.HTML` or
    :class:`~toolkit.formatted_text.ANSI` object to print formatted
    text.
    ...
    * Print a list of (style_str, text) tuples in the given style to the
    ...
    :class:`~toolkit.formatted_text.PygmentsTokens` to do the
    conversion.

    If a toolkit `Application` is currently running, this will always
...
def print_container(
    ...
    Example usage::
        ...
        from toolkit.widgets import Frame, TextArea
        print_container(
