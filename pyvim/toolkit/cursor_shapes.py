...
class CursorShape(Enum):
    ...
    # toolkit itself, people had workarounds to send cursor shapes
    # escapes into the terminal, by monkey patching some of toolkit's
    # internals. We don't want the default toolkit implementation to
