...
from ..filters import FilterOrBool, Never, to_filter
from ..keys import KEY_ALIASES, Keys
...
class KeyBindings(KeyBindingsBase):
    ...
    def add(
        ...
        *keys: Keys | str,
        ...
        :param filter: :class:`~toolkit.filters.Filter` to determine
            when this key binding is active.
        :param eager: :class:`~toolkit.filters.Filter` or `bool`.
...
class ConditionalKeyBindings(_Proxy):
    ...
    :param filter: :class:`~toolkit.filters.Filter` object.
    """
