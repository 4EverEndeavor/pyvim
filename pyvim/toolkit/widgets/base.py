...
them usable in any situation where we are expecting a `toolkit`
container object.
...
.. warning::
    ...
    `toolkit.shortcuts.dialogs` on the other hand is considered stable.
"""
...
from ..buffer import Buffer, BufferAcceptHandler
from ..completion import Completer, DynamicCompleter
...
from ..formatted_text.utils import fragment_list_to_text
...
from ..layout.dimension import AnyDimension
from ..layout.dimension import Dimension as D
from ..layout.margins import (
    ConditionalMargin,
    NumberedMargin,
    ScrollbarMargin,
)
...
class TextArea:
    ...
    :class:`~toolkit.buffer.Buffer`,
    :class:`~toolkit.layout.BufferControl` and
    :class:`~toolkit.layout.Window`.
    ...
    :param input_processors: `None` or a list of
        :class:`~toolkit.layout.Processor` objects.
    :param validator: `None` or a :class:`~toolkit.validation.Validator`
        object.

    Window attributes:

    :param lexer: :class:`~toolkit.lexers.Lexer` instance for syntax
        highlighting.
    :param wrap_lines: When `True`, don't scroll horizontally, but wrap lines.
    :param width: Window width. (:class:`~toolkit.layout.Dimension` object.)
    :param height: Window height. (:class:`~toolkit.layout.Dimension` object.)
...
class Label:
    ...
    :param text: Text to display. Can be multiline. All value types accepted by
        :class:`toolkit.layout.FormattedTextControl` are allowed,
