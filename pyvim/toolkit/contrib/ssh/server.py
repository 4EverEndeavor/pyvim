"""
Utility for running a .. application in an asyncssh server.
"""
...
from ...application.current import AppSession, create_app_session
from ...data_structures import Size
from ...input import PipeInput, create_pipe_input
...
class PromptToolkitSSHSession(asyncssh.SSHServerSession):  # type: ignore
    def __init__(
        ...
        *,
        ...
        # (This is something that we can use in the .. event loop,
...
class PromptToolkitSSHServer(asyncssh.SSHServer):
    """
    Run a .. application over an asyncssh server.
    ...
    .. applications. This function runs in an `AppSession`, which
