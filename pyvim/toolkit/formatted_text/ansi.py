...
from ..output.vt100 import BG_ANSI_COLORS, FG_ANSI_COLORS
from ..output.vt100 import _256_colors as _256_colors_table
...
class ANSI:
    ...
    be translated into a toolkit '[ZeroWidthEscape]' fragment.
    """
