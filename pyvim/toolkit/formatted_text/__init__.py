"""
Many places in . can take either plain text, or formatted text.
For instance the :func:`~..shortcuts.prompt` function takes either
plain text or formatted text for the prompt. The
:class:`~..layout.FormattedTextControl` can also take either plain
