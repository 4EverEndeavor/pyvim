...
class Buffer:
    ...
    :param complete_while_typing: :class:`~toolkit.filters.Filter`
        or `bool`. Decide whether or not to do asynchronous autocompleting while
        typing.
    :param validate_while_typing: :class:`~toolkit.filters.Filter`
        or `bool`. Decide whether or not to do asynchronous validation while
        typing.
    :param enable_history_search: :class:`~toolkit.filters.Filter` or
        ...
        through the history.
    :param read_only: :class:`~toolkit.filters.Filter`. When True,
        changes will not be allowed.
    :param multiline: :class:`~toolkit.filters.Filter` or `bool`. When
    ...
    def load_history_if_not_yet_loaded(self) -> None:
        ...
        Note::
            ...
            There are situations where toolkit applications are created
            ...
            thread.) We could decide to not support creating toolkit
    ...
    def document(self) -> Document:
        """
        Return :class:`~toolkit.document.Document` instance from the
    ...
    def document(self, value: Document) -> None:
        """
        Set :class:`~toolkit.document.Document` instance.
    ...
    def set_document(self, value: Document, bypass_readonly: bool = False) -> None:
        """
        Set :class:`~toolkit.document.Document` instance. Like the
    ...
    def document_for_search(self, search_state: SearchState) -> Document:
        """
        Return a :class:`~toolkit.document.Document` instance that has
        the text/cursor position for this search, if we would apply it. This
        will be used in the
        :class:`~toolkit.layout.BufferControl` to display feedback while
        searching.
        """
