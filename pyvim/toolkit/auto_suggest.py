...
class AutoSuggest(metaclass=ABCMeta):
    ...
    def get_suggestion(self, buffer: Buffer, document: Document) -> Suggestion | None:
        ...
        We receive both :class:`~toolkit.buffer.Buffer` and
        :class:`~toolkit.document.Document`. The reason is that auto
        ...
        :param buffer: The :class:`~toolkit.buffer.Buffer` instance.
        :param document: The :class:`~toolkit.document.Document` instance.
        """
